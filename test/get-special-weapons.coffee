...
describe 'event', ->
  ...
  context 'user says special weapon to hubot', ->
    beforeEach ->
      ...
      this.room.user.say 'uncle', '@hubot 天司器性能'
      ...
      this.room.user.say 'uncle', '@hubot 天司武器 素材ラファ'
...
https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/56676'],
        ...
        ['uncle','https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/56676'],
        ['https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/25465'],
        ['uncle','https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/38000'],
        ['uncle','https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/62344'],
      ]
